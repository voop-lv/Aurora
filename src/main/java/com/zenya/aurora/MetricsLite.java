...
public class MetricsLite {
          ...
          try {
            ...
            if (serviceProvider instanceof JsonObject) {
              ...
              try {
                ...
                if (serviceProvider.getClass().isAssignableFrom(jsonObjectJsonSimple)) {
                  Method jsonStringGetter = jsonObjectJsonSimple.getDeclaredMethod("toJSONString");
                  jsonStringGetter.setAccessible(true);
                  String jsonString = (String) jsonStringGetter.invoke(serviceProvider);
  ...
  private static void sendData(Plugin plugin, JsonObject data) throws Exception {
    ...
    if (logSentData) {
      plugin.getLogger().log(Level.INFO, "Sending data to bStats: {0}", data);
    }
